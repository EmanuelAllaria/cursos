      ...
      <Container>
        <Row>
          <Col lg={6} md={12} className="order-lg-2">
            <div 
              ref={imageRef}
              className={`section-image-container ${isImageVisible ? 'slide-in-right-on-scroll visible' : 'slide-in-right-on-scroll'}`}
            >
          ...
          <Col lg={6} md={12} className={`${isCourseSection ? 'order-lg-1' : ''}`}>
            <div 
              ref={contentRef}
              className={`section-content ${isContentVisible ? 'fade-in-on-scroll visible' : 'fade-in-on-scroll'}`}
            >
              <h2 className="section-title">{isAboutSection ? 'Acerca de' : 'Cursos'}</h2>
              {isAboutSection && (
                <>
              ...
              {isCourseSection && (
                <>
                  <p className="section-description">Explora nuestros cursos destacados y usa los filtros para encontrar el ideal para ti.</p>
