...
function Header({ page }) {
    ...
    const LogoIcon = () => (
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12 28V12h4l4 8 4-8h4v16h-3V18l-3 6h-2l-3-6v10h-3z" fill="white"/>
            <defs>
    ...
    return (
        <header className={`modern-header ${isScrolled ? 'scrolled' : ''} ${isPageHome ? 'home-page' : ''} ${isPageCourse ? 'course-page' : ''}`}>
            <nav className="nav-container">
                ...
                <div className={`mobile-nav ${isMobileMenuOpen ? 'open' : ''}`}>
                    <ul className="mobile-nav-links">
                        ...
                        <li>
                            <a href="/#course" className="mobile-nav-link" onClick={() => setIsMobileMenuOpen(false)}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <li className="mobile-cta">
                            <a href="/curso" className="btn btn-primary" onClick={() => setIsMobileMenuOpen(false)}>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                                </svg>
                                Empezar Ahora
